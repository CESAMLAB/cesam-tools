...
| [`mock_lib_regulator`](mock_lib_regulator) | Régulateur PID prêt à l'emploi (état, configuration TOML, acteur `ractor`), réutilisé tel quel par ORUE, ORSE, ORSS et OREE. |
