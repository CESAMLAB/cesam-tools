...
Die Einstellungen werden in einer Datei `mock_ru_modbus.toml` (neben der
...
| Meine Einstellungen werden nicht beibehalten. | **Anwenden** / **💾 Speichern** klicken. Die Datei `mock_ru_modbus.toml` muss beschreibbar sein. |
