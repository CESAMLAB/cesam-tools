...
[`scripts/build-prod.sh`](../../../scripts/build-prod.sh) erzeugt:
...
# Alles erzeugen (Exes in dist/ + lokales Docker-Image amd64 geladen):
scripts/build-prod.sh

# Variante: MULTI-ARCH-Docker-Image in eine Registry gepusht:
