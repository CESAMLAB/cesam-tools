...
//! régulier et applique les [`Command`] provenant de l'IHM ou du maître PROFIBUS
//! DP simulé. Modèle identique à celui d'ORME (`mock_bin_ru_modbus`) : même
//! cohérence pédagogique de régulation d'un instrument à l'autre.
