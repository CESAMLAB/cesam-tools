//! Journal circulaire des trames PROFIBUS DP échangées, pour le mini-terminal de
//! l'IHM.
//!
//! Le serveur y consigne chaque trame **reçue** (`Rx`) et chaque réponse **émise**
//! (`Tx`), formatées en hexadécimal (`text` est du texte générique, indépendant du
//! protocole) ; l'IHM le lit pour afficher le trafic. Borné à [`TRACE_CAP`] entrées
