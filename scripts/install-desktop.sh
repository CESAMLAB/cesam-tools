...
#
# Usage :
#   scripts/install-desktop.sh [orme|osne|ru_opcua|ru_spb|ru_s7|ru_eip|ru_pbdp]   # défaut : orme
set -euo pipefail

BIN="${1:-orme}"
case "$BIN" in
  orme|osne|ru_opcua|ru_spb|ru_s7|ru_eip|ru_pbdp) ;;
  *) echo "✗ Instrument inconnu : $BIN (attendu : orme | osne | ru_opcua | ru_spb | ru_s7 | ru_eip | ru_pbdp)"; exit 1 ;;
esac
